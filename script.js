...
class Block{
    constructor(blockLeft){
        ...
        this.top = (screen.offsetWidth>480?((Math.random() * 200) + 100):((Math.random() * 300) + 100))
...
playButton.addEventListener('click',function(event){
    ...
    clearScreen();
    createBlocks();
    blockMotion = (window.screen.width > 650 ? setInterval(moveBlocks,16):setInterval(moveBlocks,20));
    gravityTimer = (window.screen.width > 650 ? setInterval(gravity,20):setInterval(gravity,25));
...
//2. Event Listener on game screen
